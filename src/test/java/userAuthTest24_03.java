...
public class userAuthTest24_03 {
    @Test
    public void testAuthUser(){
        ...
        Map<String,String> cookie = responseGetAuth.getCookies();
        ...
        assertTrue(cookie.containsKey("auth_sid"), "Response doesn't have 'auth_sid' cookie");
        ...
        assertTrue(responseCheckAuth.getInt("user_id") > 0, "Unexpected user id " + userIdOnCheck);

        assertEquals(
                userIdOnAuth,
                userIdOnCheck,
                "user_id from auth request is not equal to user_id from check request"
        );
    ...
    public void testNegativeAuthUser(String condition){
        ...
        if(condition.equals("cookie")){
            spec.cookie("auth_sid",cookie.get("auth_sid"));
